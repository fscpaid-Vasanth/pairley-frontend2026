...
export default function SmartwatchIllustration({ className = "" }) {
  return (
    ...
    >
      ...
      {/* Watch Case Bezel */}
      <rect x="32" y="30" width="56" height="60" rx="16" fill="#2D2D3F" stroke="#5B12D6" strokeWidth="2" />
      {/* Inner Bezel Ring */}
      <rect x="36" y="34" width="48" height="52" rx="12" fill="#0D0D14" />

      {/* Side Button */}
      <rect x="91" y="50" width="3" height="20" rx="1.5" fill="#5B12D6" />
      <rect x="90" y="52" width="2" height="16" rx="1" fill="#7C3AED" />
      ...
      <text x="60" y="78" fill="#22C55E" fontSize="6" fontWeight="bold" textAnchor="middle" fontFamily="'Inter', sans-serif">
        9,842
      </text>
